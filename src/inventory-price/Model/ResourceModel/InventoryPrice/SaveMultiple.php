...
use PwaExt\SupplierApi\Api\Data\InventoryPriceInterface;
use PwaExt\InventoryPrice\Model\InventoryPrice;

/**
 * Class SaveMultiple
 * @package PwaExt\InventoryPrice\Model\ResourceModel\InventoryPrice
 */
class SaveMultiple
{
    /**
